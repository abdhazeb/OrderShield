...
public class GetReviewsByUserQueryHandler : IRequestHandler<GetReviewsByUserQuery, PaginatedList<ReviewDto>>
{
    private readonly IReviewRepository _repository;
    private readonly IIdentityService _identityService;

    public GetReviewsByUserQueryHandler(IReviewRepository repository, IIdentityService identityService)
    {
        _repository = repository;
        _identityService = identityService;
    }

    public async Task<PaginatedList<ReviewDto>> Handle(GetReviewsByUserQuery request, CancellationToken cancellationToken)
    {
