...
@Component({
  ...
  template: `
    <nav class="bottom-nav">
      ...
      <a routerLink="/enquiries" routerLinkActive="active" class="nav-item">
        ...
        <span class="nav-label">{{ 'nav.enquiries' | translate }}</span>
      </a>
      ...
      @if (authService.isAdmin()) {
        <a routerLink="/admin" routerLinkActive="active" class="nav-item">
          <svg class="nav-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15v2m-6 4h12a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2zm10-10V7a4 4 0 0 0-8 0v4h8z"/></svg>
